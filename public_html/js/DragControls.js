 ...
 */
THREE.DragControls = function( _camera, _objects, _domElement, _controls ) {
	...
	function onDocumentMouseMove( event ) {
		...
		_mouse.x = ( (event.clientX - _domElement.offsetLeft) / _domElement.offsetWidth ) * 2 - 1;
		_mouse.y = - ( (event.clientY - _domElement.offsetTop) / _domElement.offsetHeight ) * 2 + 1;
